...
public class LocationDbAdapter {
    ...
    private static final String DATABASE_CREATE =
        ...
        + "name text not null, latitude real not null, longitude real not null, altitude real not null, accuracy integer not null, time integer not null);";
    ...
    public Cursor fetchAllLocations() {
        ...
        return mDb.query(DATABASE_TABLE, new String[] {KEY_ROWID, KEY_NAME, KEY_LATITUDE, KEY_LONGITUDE, KEY_ALTITUDE, KEY_ACCURACY,
