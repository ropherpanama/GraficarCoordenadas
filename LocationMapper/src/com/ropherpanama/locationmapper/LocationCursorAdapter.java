...
//	private static final String TAG = LocationCursorAdapter.class.toString();
	...
	public View getView(int pos, View inView, ViewGroup parent) {
		...
		String altitude = new DecimalFormat("###.####").format(this.c.getDouble(this.c.getColumnIndex(LocationDbAdapter.KEY_ALTITUDE)));
		view = (TextView) v.findViewById(R.id.locationaltitude);
